...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>AnhKhoachào ae<Color=/>"):Display()
    wait(.5)
...
OrionLib:MakeNotification({
        Name = "AnhKhoa",
        Content = "chào Ae!, You can now enable the function!",
        Image = "rbxassetid://8192162908",
        Time = 5
    })
